...
class CustomFieldTextDesc @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : ConstraintLayout(context, attrs, defStyleAttr) {

    private val maxCharacterCount = 2500
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.character_counter_desc, this, true)

        textInputLayout = findViewById(R.id.textInputLayout)
        editTextField = findViewById(R.id.editTextFieldDesc)
        ...
        editTextField.addTextChangedListener { text ->
            ...
            characterCounter.text = "$currentLength/$maxCharacterCount karakter"

            textInputLayout.error = if (currentLength < minCharacterCount) {
                context.getString(R.string.input_too_short_desc)
            } else {
                null
            }
